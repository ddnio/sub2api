-- Account statistics pricing for channel-level account cost tracking.
-- This is schema-only; historical aggregate backfill should use the dashboard backfill endpoint.
