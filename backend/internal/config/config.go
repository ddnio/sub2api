...
// DefaultUpstreamResponseReadMaxBytes is the default read limit for non-streaming upstream responses.
// 128 MB covers large inline image payloads while remaining below the default request body limit.
