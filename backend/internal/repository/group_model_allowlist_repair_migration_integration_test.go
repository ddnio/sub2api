...
const groupModelAllowlistRepairMigration = "256_group_model_allowlist_repair.sql"
...
func TestMigration256RenamesLegacyModelsListConfigColumn(t *testing.T) {
	tx := testTx(t)
...
func TestMigration256BackfillsWhenBothColumnsExist(t *testing.T) {
	tx := testTx(t)
	ctx := context.Background()
...
func TestMigration256RecreatesMissingModelAllowlistColumn(t *testing.T) {
	tx := testTx(t)
	ctx := context.Background()
