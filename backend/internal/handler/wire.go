...
func ProvideHandlers(
	...
	studioAuthHandler *StudioAuthHandler,
	userHandler *UserHandler,
	apiKeyHandler *APIKeyHandler,
	imageCreationHandler *ImageCreationSessionHandler,
	imageCreationAPIHandler *ImageCreationHandler,
	...
	return &Handlers{
		Auth:             authHandler,
		StudioAuth:       studioAuthHandler,
		User:             userHandler,
		APIKey:           apiKeyHandler,
		ImageCreation:    imageCreationHandler,
		ImageCreationAPI: imageCreationAPIHandler,
		Usage:            usageHandler,
		Redeem:           redeemHandler,
		Subscription:     subscriptionHandler,
		Announcement:     announcementHandler,
...
var ProviderSet = wire.NewSet(
	// Top-level handlers
	NewAuthHandler,
	NewStudioAuthHandler,
	NewUserHandler,
	NewAPIKeyHandler,
	NewImageCreationSessionHandler,
	NewImageCreationHandler,
	NewUsageHandler,
	NewRedeemHandler,
