...
func TestGetModelPricing_RemovedGPT51StillUsesNormalizedGPT54Fallback(t *testing.T) {
	svc := newTestBillingService()
...
func TestGetModelPricing_RemovedGPT54NanoStillUsesNormalizedGPT54Fallback(t *testing.T) {
	svc := newTestBillingService()
...
func TestGetFallbackPricing_FamilyMatching(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "openai removed gpt5.1 uses normalized gpt5.4 fallback", model: "gpt-5.1", expectedInput: 2.5e-6},
		{name: "openai gpt5.4", model: "gpt-5.4", expectedInput: 2.5e-6},
		{name: "openai gpt5.4 mini", model: "gpt-5.4-mini", expectedInput: 7.5e-7},
		{name: "openai removed gpt5.4 nano uses normalized gpt5.4 fallback", model: "gpt-5.4-nano", expectedInput: 2.5e-6},
		{name: "openai gpt5.3 codex", model: "gpt-5.3-codex", expectedInput: 1.5e-6},
		{name: "openai legacy gpt5.1 codex max normalizes to current codex fallback", model: "gpt-5.1-codex-max", expectedInput: 1.5e-6},
