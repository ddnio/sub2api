...
// cyberFakeSettingRepo is a minimal SettingRepository stub for unit tests.
...
type cyberFakeSettingRepo struct {
	vals map[string]string
}

func (r *cyberFakeSettingRepo) GetValue(_ context.Context, key string) (string, error) {
	v, ok := r.vals[key]
	if !ok {
...
func (r *cyberFakeSettingRepo) Get(_ context.Context, _ string) (*Setting, error) {
	panic("cyberFakeSettingRepo.Get not implemented")
}
func (r *cyberFakeSettingRepo) Set(_ context.Context, _, _ string) error {
	panic("cyberFakeSettingRepo.Set not implemented")
}
func (r *cyberFakeSettingRepo) GetMultiple(_ context.Context, _ []string) (map[string]string, error) {
	panic("cyberFakeSettingRepo.GetMultiple not implemented")
}
func (r *cyberFakeSettingRepo) SetMultiple(_ context.Context, _ map[string]string) error {
	panic("cyberFakeSettingRepo.SetMultiple not implemented")
}
func (r *cyberFakeSettingRepo) GetAll(_ context.Context) (map[string]string, error) {
	panic("cyberFakeSettingRepo.GetAll not implemented")
}
func (r *cyberFakeSettingRepo) Delete(_ context.Context, _ string) error {
	panic("cyberFakeSettingRepo.Delete not implemented")
}

var _ SettingRepository = (*cyberFakeSettingRepo)(nil)
...
func TestCyberSessionBlock_RoundTrip(t *testing.T) {
	...
	settingSvc := &SettingService{
		settingRepo: &cyberFakeSettingRepo{
			vals: map[string]string{
...
func TestFindCyberSessionBlockedForRequestUsesScopeForTranscript(t *testing.T) {
	settingSvc := &SettingService{settingRepo: &cyberFakeSettingRepo{vals: map[string]string{
		SettingKeyCyberSessionBlockEnabled:    "true",
		SettingKeyCyberSessionBlockTTLSeconds: "60",
	}}}
	combo := &comboCacheAndStore{}
