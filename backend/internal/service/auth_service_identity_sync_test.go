...
func newAuthServiceWithIdentityEnt(t *testing.T) (*service.AuthService, service.UserRepository, *dbent.Client) {
	t.Helper()
...
func TestAuthServiceLoginBackfillsEmailIdentityAndTouchesLastLoginAt(t *testing.T) {
