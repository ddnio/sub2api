...
func TestGetModelPricing_Gpt53CodexSparkUsesGpt53CodexPricing(t *testing.T) {
	sparkPricing := &LiteLLMModelPricing{InputCostPerToken: 1}
	gpt53Pricing := &LiteLLMModelPricing{InputCostPerToken: 9}

	svc := &PricingService{
		pricingData: map[string]*LiteLLMModelPricing{
			"gpt-5.3-codex": sparkPricing,
...
func TestGetModelPricing_Gpt53CodexFallbackUsesGpt53Codex(t *testing.T) {
	gpt53CodexPricing := &LiteLLMModelPricing{InputCostPerToken: 2}
	...
	require.Same(t, gpt53CodexPricing, got)
}
...
func TestGetModelPricing_ClaudeOpus47FallsBackToOpus46Pricing(t *testing.T) {
	...
	opus4Pricing := &LiteLLMModelPricing{InputCostPerToken: 15e-6}
...
func TestGetModelPricing_OpenAIFallbackMatchedLoggedAsInfo(t *testing.T) {
	...
	require.True(t, logSink.ContainsMessageAtLevel("[Pricing] OpenAI fallback matched gpt-5.3-codex-high -> gpt-5.3-codex", "info"))
	require.False(t, logSink.ContainsMessageAtLevel("[Pricing] OpenAI fallback matched gpt-5.3-codex-high -> gpt-5.3-codex", "warn"))
}
...
func TestGetModelPricing_RemovedGpt54NanoUsesGpt54StaticFallbackWhenRemoteMissing(t *testing.T) {
	svc := &PricingService{
		pricingData: map[string]*LiteLLMModelPricing{
			"gpt-5.3-codex": {InputCostPerToken: 1.5e-6},
		},
	}
