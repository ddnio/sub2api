...
const (
	// Label holds the string label denoting the imagecreationchangelog type in the database.
	Label = "image_creation_change_log"
	...
	EdgeActor = "actor"
	// Table holds the table name of the imagecreationchangelog in the database.
	Table = "image_creation_change_logs"
	// ActorTable is the table that holds the actor relation/edge.
	ActorTable = "image_creation_change_logs"
...
// Columns holds all SQL columns for imagecreationchangelog fields.
var Columns = []string{
	FieldID,
	FieldActorUserID,
	FieldAction,
...
// OrderOption defines the ordering options for the ImageCreationChangeLog queries.
