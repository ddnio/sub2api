...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			imagecreationasset.Table:            imagecreationasset.ValidColumn,
			imagecreationchangelog.Table:        imagecreationchangelog.ValidColumn,
			imagecreationtemplate.Table:         imagecreationtemplate.ValidColumn,
