export default {
  ...
  customPage: {
    ...
    imageCreationConnectingTitle: 'Connecting to Image Creation',
    imageCreationConnectingDesc: 'Establishing a secure session. Please wait.',
    imageCreationSessionFailed: 'Failed to load the image creation session. Please try again.',
    imageCreationRetry: 'Retry',
    imageCreationPopupBlocked: 'The browser blocked the new window. Allow pop-ups and try again.',
    imageCreationOpenFailed: 'Failed to open a new window. Please try again.',
    imageCreationRetryOpen: 'Open again',
