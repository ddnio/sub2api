export default {
  ...
  auth: {
    ...
    referralCodePlaceholder: '填写好友的推荐码',
    referralCodeApplied: '推荐码 {code} 已应用，注册并完成首次充值后，双方将获得奖励',
  ...
  referral: {
    title: '邀请好友',
    description: '好友注册并完成首次充值后，双方各得余额奖励',
    myCode: '我的推荐码',
    copyLink: '复制链接',
    linkCopied: '邀请链接已复制',
    totalInvited: '已邀请人数',
    totalRewarded: '累计获得奖励',
    rewardPerInvite: '激活后奖励',
    inviterGets: '邀请人',
    inviteeGets: '被邀请人',
    ...
    statusGranted: '已奖励',
    statusPending: '待首充激活',
    pendingTooltip: '好友已注册，但需完成首次充值后，双方奖励才会到账',
  },
  redeem: {
    title: '兑换码',
  ...
  admin: {
    ...
    users: {
      ...
      referralInfo: '邀请信息',
      referralInfoTitle: '用户邀请信息',
      referralInfoBtn: '邀请信息',
      referralInviteCount: '邀请人数',
      referralInvitedBy: '被谁邀请',
      referralCode: '推荐码',
    ...
    channels: {
      ...
      form: {
        ...
        applyPricingToAccountStats: '账号统计计价',
        applyPricingToAccountStatsHint: '开启后，账号成本统计会优先使用请求的用户收费金额，再应用账号倍率；命中自定义规则时按规则计价。',
        accountStatsPricingRules: '账号统计计价规则',
        noAccountStatsPricingRules: '暂无自定义账号统计计价规则',
        ruleName: '规则名称',
        ruleGroupIds: '分组 ID，多个用英文逗号分隔',
        ruleAccountIds: '账号 ID，多个用英文逗号分隔',
        selectedCount: '已选 {count} 个',
        searchGroups: '搜索分组...',
  ...
  payment: {
    ...
    admin: {
      ...
      enabledPaymentTypes: '启用支付方式',
      enabledPaymentTypesHint: '只有启用后的支付方式才会展示给用户，并可绑定服务商实例。',
      enableTypesFirst: '请先启用至少一种支付方式',
      typeDisabled: '支付方式未启用',
      paymentMode: '支付模式',
      modeQRCode: '二维码',
      modePopup: '弹窗',
      limitsTitle: '限额配置',
      ...
      limitSingleMax: '单笔最高',
      limitDaily: '每日限额',
      limitsHint: '留空表示使用全局支付配置；同一支付方式存在多个服务商时，会按可用限额聚合。',
      limitsNoLimit: '不限制',
      limitsUseGlobal: '使用全局配置',
      paymentGuideTrigger: '查看配置说明',
      guideOpenLabel: '开通：',
      guideCallLabel: '接口：',
      guideFallbackLabel: '兜底：',
      validationNameRequired: '请输入服务商名称',
      ...
      field_returnUrl: '同步返回地址',
      stripeWebhookHint: '请在 Stripe 后台配置以下 Webhook 地址。',
      alipayGuideSummary: '支付宝官方支付可按终端场景选择当面付、电脑网站支付或手机网站支付。',
      alipayGuideFaceToFaceTitle: '当面付',
      alipayGuideFaceToFaceOpen: '在支付宝开放平台开通当面付产品。',
      alipayGuideFaceToFaceCall: '桌面扫码支付优先使用预下单二维码能力。',
      alipayGuideFaceToFaceFallback: '移动端可切换到网站支付能力。',
      alipayGuidePagePayTitle: '电脑网站支付',
      alipayGuidePagePayOpen: '在支付宝开放平台开通电脑网站支付。',
      alipayGuidePagePayCall: '桌面端可跳转或弹窗打开收银台。',
      alipayGuidePagePayFallback: '不支持扫码时使用收银台跳转。',
      alipayGuideWapTitle: '手机网站支付',
      alipayGuideWapOpen: '在支付宝开放平台开通手机网站支付。',
      alipayGuideWapCall: '移动浏览器跳转到支付宝收银台。',
      alipayGuideWapFallback: '桌面端优先使用扫码或电脑网站支付。',
      wxpayGuideSummary: '微信支付按场景使用 Native、JSAPI 或 H5，当前推荐先配置 Native 扫码。',
      wxpayGuideNote: 'JSAPI/H5 需要微信商户平台与公众号/开放平台的授权域名配置正确。',
      wxpayGuideNativeTitle: 'Native 支付',
      wxpayGuideNativeOpen: '在微信商户平台开通 Native 支付。',
      wxpayGuideNativeCall: '桌面端生成二维码供用户扫码支付。',
      wxpayGuideNativeFallback: '移动端可退回二维码展示。',
      wxpayGuideJsapiTitle: 'JSAPI 支付',
      wxpayGuideJsapiOpen: '绑定公众号并配置网页授权域名。',
      wxpayGuideJsapiCall: '微信内浏览器使用 JSAPI 拉起支付。',
      wxpayGuideJsapiFallback: '授权失败时回退到 Native 二维码。',
  ...
  adminPayment: {
    ...
    retryOrder: '重试发放',
    refundOrder: '退款',
    confirmComplete: '确定手动完成此订单并发放权益？',
    confirmRetry: '确定重试此订单的权益发放？',
    confirmRefund: '确定对此订单进行退款处理？',
    adminNote: '备注（可选）',
