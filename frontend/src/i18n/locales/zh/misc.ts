export default {
  ...
  customPage: {
    ...
    imageCreationConnectingTitle: '正在连接图像创作',
    imageCreationConnectingDesc: '正在建立安全会话，请稍候。',
    imageCreationSessionFailed: '图像创作会话加载失败，请重试。',
    imageCreationRetry: '重试',
    imageCreationPopupBlocked: '浏览器阻止了新窗口，请允许弹出窗口后重试。',
    imageCreationOpenFailed: '新窗口打开失败，请重试。',
    imageCreationRetryOpen: '重新打开',
    tableOfContents: '目录',
    copyCode: '复制',
    copiedCode: '已复制',
    copyCodeFailed: '失败'
