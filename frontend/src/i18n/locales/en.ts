export default {
  ...
  auth: {
    ...
    referralCodeApplied: 'Referral code {code} applied. Both of you will receive rewards after registration.',
  ...
  referral: {
    title: 'Referral',
    description: 'Invite friends to register and both of you will receive rewards',
  ...
  payment: {
    ...
    payNow: 'Pay Now',
    paying: 'Processing...',
    scanQRCode: 'Scan with {provider} to pay',
    qrCodeExpires: 'QR code expires in',
    paymentSuccess: 'Payment Successful!',
    paymentFailed: 'Payment Failed',
    paymentTimeout: 'Payment timed out, please create a new order',
    orderCreated: 'Order Created',
    duration: '{days} days',
    durationUnit: 'days',
    perMonth: '/month',
    originalPrice: 'Original',
    topupAmount: 'Amount (CNY)',
    topupAmountPlaceholder: 'Enter amount',
    topupMin: 'Min {min} CNY',
    topupMax: 'Max {max} CNY',
