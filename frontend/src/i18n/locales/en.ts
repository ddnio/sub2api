export default {
  ...
  docs: {
    ...
    quickStart: {
      title: 'Quick Start',
      subtitle: 'Choose your client and follow the matching guide to configure the API URL and key.',
      baseUrlLabel: 'Base URL',
      getKeyStep: 'Create an API Key',
      getKeyDesc: 'Sign in to the dashboard, then create or copy your key from the API Key page.',
      chooseToolStep: 'Choose a client',
      chooseToolDesc: 'Pick the guide for your tool, copy the example, and replace it with your API key.',
      toolCards: {
        claudeCode: 'Configure Claude Code to use this gateway.',
        codexCli: 'Configure Codex CLI with the Responses API route.',
        opencode: 'Configure the OpenCode provider and model settings.',
        apiUsage: 'See basic OpenAI-compatible API request examples.'
      }
    }
  },
  ...
  admin: {
    ...
    ops: {
      ...
      errorDetail: {
        ...
        requestBodyBytes: 'Original Bytes',
