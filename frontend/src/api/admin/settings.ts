...
export interface AuthSourceDefaultsValue {
  ...
  // Platform quota overrides keyed by platform.
...
function defaultAuthSourceDefaults(): AuthSourceDefaultsValue {
  return {
...
export function appendAuthSourceDefaultsToUpdateRequest(
  ...
  for (const source of AUTH_SOURCE_TYPES) {
    const current = authSourceDefaults[source] ?? defaultAuthSourceDefaults();
