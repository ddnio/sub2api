<template>
  <div class="flex flex-col gap-0.5">
    ...
    <div v-if="showWindowCost" class="flex items-center gap-1">
      <CapacityBadge :color-class="windowCostClass" :tooltip="windowCostTooltip" :current="'$' + formatCost(currentWindowCost)" :max="'$' + formatCost(account.window_cost_limit)">
    ...
    <div v-if="showSessionLimit" class="flex items-center gap-1">
      <CapacityBadge :color-class="sessionLimitClass" :tooltip="sessionLimitTooltip" :current="activeSessions" :max="account.max_sessions!">
        <svg class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div v-if="showRpmLimit" class="flex items-center gap-1">
      <CapacityBadge :color-class="rpmClass" :tooltip="rpmTooltip" :current="currentRPM" :max="account.base_rpm!" :suffix="rpmStrategyTag">
