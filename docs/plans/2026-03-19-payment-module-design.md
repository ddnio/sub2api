...
> 日期：2026-03-19
> 更新：2026-03-20
> 状态：已实现（feature/payment-module，待合并 main）
> 分支：feature/payment-module

## 概述

为 Sub2API 平台增加自助支付功能，支持用户在线购买订阅套餐和充值余额。一期支持微信支付 Native Pay（扫码），通过 PaymentProvider 抽象层为后续接入更多支付渠道留出扩展空间。

> **实现说明（2026-03-20）**：原设计支持支付宝，最终一期仅对接微信支付官方 API（Native Pay v3），直连商户不经过中间平台，费率 0.6%。
