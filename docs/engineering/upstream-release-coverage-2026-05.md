...
| `4d0483f5` | GPT image model test feature | Image-adjacent test/admin feature. | OPEN | Process next in the same image slice now that PR #1795 route/service foundation is present. |
